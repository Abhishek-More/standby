    ...
    >
      ...
      <div className="max-w-4xl mx-auto mt-16 md:mt-40 text-center">
        ...
        <p className="text-[#6b7280] mx-auto text-lg md:text-xl mb-16 max-w-3xl leading-tight">
          ...
          <span className="rotate-[8deg] transform inline-block"> broken </span>
          . no more competitive programming or google doc awkwardness — starting
          with system design, we&apos;re revolutionizing technical hiring.
        </p>
